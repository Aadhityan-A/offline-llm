...
| Platform | Download |
|----------|----------|
| Windows | [offline-llm-windows-x64.zip](https://github.com/Aadhityan-A/offline-llm/releases/download/v1.4.0/offline-llm-windows-x64.zip) |
| macOS | [offline-llm-macos.zip](https://github.com/Aadhityan-A/offline-llm/releases/download/v1.4.0/offline-llm-macos.zip) |
| Linux (tar) | [offline-llm-linux-x64.tar.gz](https://github.com/Aadhityan-A/offline-llm/releases/download/v1.4.0/offline-llm-linux-x64.tar.gz) |
| Linux (DEB) | [offline-llm_1.4.0_amd64.deb](https://github.com/Aadhityan-A/offline-llm/releases/download/v1.4.0/offline-llm_1.4.0_amd64.deb) |
| Linux (RPM) | [offline-llm-1.4.0.x86_64.rpm](https://github.com/Aadhityan-A/offline-llm/releases/download/v1.4.0/offline-llm-1.4.0.x86_64.rpm) |
| Android | [offline-llm-android.apk](https://github.com/Aadhityan-A/offline-llm/releases/download/v1.4.0/offline-llm-android.apk) |
